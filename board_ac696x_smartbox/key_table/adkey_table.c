...
const u16 bt_key_ad_table[KEY_AD_NUM_MAX][KEY_EVENT_MAX] = {
    ...
    [1] = {
        KEY_SEND_SPEECH_START,		KEY_NULL,			KEY_NULL,			KEY_NULL,		KEY_NULL,			KEY_NULL
    },
    [2] = {
        KEY_MUSIC_PP,	KEY_CALL_HANG_UP,	KEY_NULL,			KEY_NULL,		KEY_TWS_SEARCH_REMOVE_PAIR,	KEY_NULL
    },
    [3] = {
    ...
    [6] = {
        KEY_MUSIC_NEXT,	KEY_VOL_UP,			KEY_VOL_UP,			KEY_NULL,		KEY_SEND_SPEECH_START,	KEY_NULL
    },
    [7] = {
        KEY_NULL,		KEY_NULL,			KEY_NULL,			KEY_NULL,		KEY_NULL,			KEY_NULL
    },
