        ...
        case USB_DT_STRING:
            ...
            case 0x80:
                if (usb_device->bDeviceStates == USB_DEFAULT) {
                    ...
                    usb_set_data_payload(usb_device, req, user80_stirng, sizeof(user80_stirng));
                    ret = 1;
                }
                break;
            case 0x81:
                if (usb_device->bDeviceStates == USB_DEFAULT) {
                    ...
                    usb_set_data_payload(usb_device, req, user81_stirng, sizeof(user81_stirng));
                    ret = 1;
                }
                break;
#endif
