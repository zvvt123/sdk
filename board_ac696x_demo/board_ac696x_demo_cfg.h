...
//                                  app 配置                                       //
//*********************************************************************************//
#define TCFG_APP_BT_EN			                                             1  // 使能蓝牙
#define TCFG_APP_MUSIC_EN			                                         1  // 使能音乐播放
#define TCFG_APP_LINEIN_EN					                                 0  // 使能线入
#define TCFG_APP_FM_EN					                                     0  // 使能FM
#define TCFG_APP_PC_EN					                                     0  // 使能PC
#define TCFG_APP_RTC_EN					                                     0  // 使能RTC
#define TCFG_APP_RECORD_EN				                                     0  // 使能录音
#define TCFG_APP_SPDIF_EN                                                    0  // 使能SPDIF
//*********************************************************************************//
//                               PCM_DEBUG调试配置                                 //
//*********************************************************************************//
...
//                                功放配置(普通加分压式)                           //
//*********************************************************************************//
#define TCFG_MUTE_ENABLE                                                    ENABLE_THIS_MOUDLE                     // 功放使能

#define TCFG_MUTE_EFFECTIVE                                                 0                                      //0:低MUTE    1:高MUTE

#define TCFG_VAL_HALF_MUTE                                                  0                                      //0:不使用内部分压       1:使用内部分压

#if TCFG_VAL_HALF_MUTE

#define TCFG_VAL_HALF_IO                                                    IO_PORTA_02

#else

#define TCFG_MUTE_IO                                                        IO_PORTB_07

#endif

#define TCFG_AB_MUTE                                                        0                                       //0:关闭AB类  1:AB类使能
#if TCFG_AB_MUTE
#define TCFG_AB_MUTE_IO                                                     IO_PORTA_02
#define MUTE_AB(x)                                                          do{if(x){gpio_direction_output(TCFG_AB_MUTE_IO,1);gpio_set_pull_up(TCFG_AB_MUTE_IO,0);\
                                                                            gpio_set_pull_down(TCFG_AB_MUTE_IO,0);\
                                                                            gpio_set_direction(TCFG_AB_MUTE_IO,0);}\
                                                                            else{gpio_direction_output(TCFG_AB_MUTE_IO,0);gpio_set_pull_up(TCFG_AB_MUTE_IO,0);\
                                                                            gpio_set_pull_down(TCFG_AB_MUTE_IO,0);\
                                                                            gpio_set_direction(TCFG_AB_MUTE_IO,0);}\
                                                                            }while(0)
#endif
...
//*********************************************************************************//
//                               MOS管开关机类                                     //
//保持脚选择:IO_PORTA_09  IO_PORTA_10 IO_PORTB_02  IO_PORTB_01(pb1默认上拉,不考虑) //
//           IO_PORTB_06  IO_PORTB_07 USB_DP_DM                                    //
//*********************************************************************************//
#define TCFG_MOS_ENABLE                                                     DISABLE_THIS_MOUDLE         //MOS管开关机使能,使用MOS管时，为达到长按开机效果,需要选择每次上电校准MIC
#if TCFG_MOS_ENABLE
#define MOS_POWER_IO                                                        IO_PORTB_06
#define MSG_POWER_ON()                                                      do{gpio_direction_output(MOS_POWER_IO,1);gpio_set_pull_up(MOS_POWER_IO,0);\
                                                                               gpio_set_pull_down(MOS_POWER_IO,0);\
                                                                               gpio_set_direction(MOS_POWER_IO,0);}while(0)

#define MSG_POWER_OFF()                                                     do{gpio_direction_output(MOS_POWER_IO,0);gpio_set_pull_up(MOS_POWER_IO,0);\
                                                                               gpio_set_pull_down(MOS_POWER_IO,0);\
                                                                               gpio_set_direction(MOS_POWER_IO,0);}while(0)
#endif
...
#define TCFG_DEV_POWER_ENABLE                                               DISABLE_THIS_MOUDLE                     //0:开机不保持供电       1:开机保持供电
#if TCFG_DEV_POWER_ENABLE
#define TCFG_DEV_POWER_IO                                                   IO_PORTB_07
#define TCFG_DEV_POWER_ON()                                                 do{gpio_direction_output(TCFG_DEV_POWER_IO,1);gpio_set_pull_up(TCFG_DEV_POWER_IO,0);\
                                                                               gpio_set_pull_down(TCFG_DEV_POWER_IO,0);\
                                                                               gpio_set_direction(TCFG_DEV_POWER_IO,0);}while(0)

#define TCFG_DEV_POWER_OFF()                                                do{gpio_direction_output(TCFG_DEV_POWER_IO,0);gpio_set_pull_up(TCFG_DEV_POWER_IO,0);\
                                                                               gpio_set_pull_down(TCFG_DEV_POWER_IO,0);\
                                                                               gpio_set_direction(TCFG_DEV_POWER_IO,0);}while(0)
#endif
...
#define TCFG_LOW_POWER_DETECTING			                                DISABLE_THIS_MOUDLE                     //外部电量检测使能
#if TCFG_LOW_POWER_DETECTING
#define VAL_DETECTION_IO                                                    IO_PORTA_03
#define VAL_DETECTION_CH                                                    AD_CH_PA3
#define VAL_DETECTION_INIT()                                                do{gpio_set_direction(VAL_DETECTION_IO,1);gpio_set_pull_down(VAL_DETECTION_IO, 0);\
                                                                               gpio_set_pull_up(VAL_DETECTION_IO, 0);adc_add_sample_ch(VAL_DETECTION_CH);\
                                                                               adc_get_voltage(VAL_DETECTION_CH);\
                                                                               gpio_set_die(VAL_DETECTION_IO, 1);}while(0)
#endif
...
#define TCF_MIC_DETECTION_ENABLE                                            DISABLE_THIS_MOUDLE                       //MIC插入检测
#if TCF_MIC_DETECTION_ENABLE
#define TCFG_MIC_DETECTION_IO                                               IO_PORTB_05
#define TCFG_MIC_DETECTION_ONLINE()                                         gpio_read(TCFG_MIC_DETECTION_IO)
#define TCFG_MIC_DETECTION_INIT()                                           do{gpio_set_direction(TCFG_MIC_DETECTION_IO,1);\
                                                                               gpio_set_pull_down(TCFG_MIC_DETECTION_IO, 1);\
                                                                               gpio_set_pull_up(TCFG_MIC_DETECTION_IO, 0);\
                                                                               gpio_set_die(TCFG_MIC_DETECTION_IO, 1);gpio_set_hd(TCFG_MIC_DETECTION_IO, 1);}while(0)
#endif

//*********************************************************************************//
//                                 电位器配置                                      //
//*********************************************************************************//
#define TCFG_MUSIC_VOL_DETECTION                                             DISABLE_THIS_MOUDLE
#if TCFG_MUSIC_VOL_DETECTION
#define TCFG_MUSIC_VOL_IO                                                    IO_PORTA_04
#define TCFG_MUSIC_VOL_AD                                                    AD_CH_PA4
#define TCFG_MUSIC_VOL_INIT()                                                do{gpio_direction_input(TCFG_MUSIC_VOL_IO);\
                                                                              gpio_set_pull_down(TCFG_MUSIC_VOL_IO, 0);\
                                                                              gpio_set_pull_up(TCFG_MUSIC_VOL_IO, 0);\
                                                                              gpio_set_die(TCFG_MUSIC_VOL_IO, 1);}while(0)
...
//                                 编码器配置                                      //
//*********************************************************************************//
#define TCFG_ENCODER_DETECTION                                               DISABLE_THIS_MOUDLE
#if TCFG_ENCODER_DETECTION
#define TCFG_ENCODER_ONE_IO                                                  IO_PORTA_06
#define TCFG_ENCODER_TWO_IO                                                  IO_PORTA_05
#endif

//*********************************************************************************//
//                                常规类配置(开发必看)                             //
//*********************************************************************************//
#define TCFG_LOW_POWER                                                      ENABLE_THIS_MOUDLE               //0:低电提示音不限制次数                      1:低电时，报三次后关机
#define TCFG_DEV_OUT_BT                                                     ENABLE_THIS_MOUDLE               //0:设备拔出进入下一个模式(设备在线时优先)，  1:设备拔出回蓝牙
#define TCFG_POWER_ON_DEV                                                   ENABLE_THIS_MOUDLE               //0:开机蓝牙模式                              1:开机有设备进设备
#define TCFG_XUAN_LED_ENABLE                                                DISABLE_THIS_MOUDLE              //0:5050 RGB关闭                            1:5050 RGB开启
//////////////////////////////////////////////////////////////////////////////////////////////////////
//                                    用户自定义                                                    //
/////////////////////////////////////////////////////////////////////////////////////////////////////
#define TCFG_FLASH_ENABLE                                                   DISABLE_THIS_MOUDLE                //FLASH断点增加处   此宏只能跟随到文件处，没有任何功能
#define TCFG_XIAODU_ENABLE                                                  DISABLE_THIS_MOUDLE                //小度   此宏只能跟随到文件处，没有任何功能
//*********************************************************************************//
//                                蓝牙类配置(开发必看)                              //
//*********************************************************************************//
#define TCFG_TWS_TONE_BT                                                    ENABLE_THIS_MOUDLE              //0:TWS提示音与蓝牙提示音共用                 1:TWS提示音与蓝牙提示音不共用
#define TCFG_BT_CLAA_VABT                                                   DISABLE_THIS_MOUDLE             //0:通话关闭时开启电量显示                  1:通话关闭保留电量显示
//*********************************************************************************//
//                                音乐类配置(开发必看)                             //
//*********************************************************************************//
#define TCFG_MUSIC_DEV_ONLINE                                               ENABLE_THIS_MOUDLE              //0:不优化SD复用USB，部分USB不读              1:优化SD复用USB，部分USB不读
...
//                                  SD 配置                                        //
//*********************************************************************************//
#define     SD_CMD_DECT 	                                                 0   //SD_CMD_DECT为0时，SD卡插入检测通过SD_CMD引脚电平变化实现。
#define     SD_CLK_DECT  	                                                 1   //SD_CLK_DECT为1时，SD卡插入检测通过SD_CLK引脚电平变化实现。
#define     SD_IO_DECT 		                                                 2   //SD_IO_DECT为2时，SD卡插入检测通过SD_CMD引脚电平变化实现。
...
#define TCFG_IOKEY_PREV_ONE_PORT			                                   IO_PORTA_03

// #define TCFG_IOKEY_NEXT_CONNECT_WAY 		                                   ONE_PORT_TO_LOW  //按键一端接低电平一端接IO
// #define TCFG_IOKEY_NEXT_ONE_PORT			                                   IO_PORTA_02
...
//                                  LED 配置                                       //
//******************************************************************************
#define  TCFG_LED_H_OR_L                                                             ENABLE_THIS_MOUDLE                 //0:led开启低亮(蓝灯:LED0)        1:led开启高亮(红灯:LED1)
...
#define AUDIO_EFFECTS_DRC_AT_RAM                                                     0  //开混响DRC放ram
...
#define USER_SUPPORT_PROFILE_HFP                                                     1  //通话模式
