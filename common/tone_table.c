...
const char *tone_table[] = {
...
#else
    [IDEX_TONE_TWS_CONN] 		= TONE_RES_ROOT_PATH"tone/bt_conn.*",
    [IDEX_TONE_TWS_DISCONN]		= TONE_RES_ROOT_PATH"tone/bt_dconn.*",
#endif
    ...
    [IDEX_TONE_MAX_VOL] 		= TONE_RES_ROOT_PATH"tone/vol_max.*",
    ...
    [IDEX_TONE_TWS_SCAN] 	    = TONE_RES_ROOT_PATH"tone/tws_scan.*",

    [IDEX_TONE_MOYIN] 		    = TONE_RES_ROOT_PATH"tone/moyin.*",    // 魔音
    [IDEX_TONE_NAN_SHEN] 		= TONE_RES_ROOT_PATH"tone/nan_shen.*", // 男声
    [IDEX_TONE_NV_SHEN] 		= TONE_RES_ROOT_PATH"tone/nv_shen.*",  // 女声
    [IDEX_TONE_WA_WA] 		    = TONE_RES_ROOT_PATH"tone/wa_wa.*",    // 娃娃
    [IDEX_TONE_YUAN_SHEN] 		= TONE_RES_ROOT_PATH"tone/yuan_shen.*", // 原声
    [IDEX_TONE_ECHO_START] 		= TONE_RES_ROOT_PATH"tone/echo_start.*", //消音开
    [IDEX_TONE_ECHO_STOP] 		= TONE_RES_ROOT_PATH"tone/echo_stop.*",  //消音关
    [IDEX_TONE_MIC_TJ] 	        = TONE_RES_ROOT_PATH"tone/mic_tj.*",      //话筒调节
    [IDEX_TONE_ECHO_TJ] 	    = TONE_RES_ROOT_PATH"tone/echo_tj.*",     //混响调节
    [IDEX_TONE_MUSIC_TJ] 	    = TONE_RES_ROOT_PATH"tone/music_tj.*",     //音乐调节
    [IDEX_TONE_MIC_ON] 		    = TONE_RES_ROOT_PATH"tone/mic_on.*",        //麦克风开
    [IDEX_TONE_MIC_OFF] 	    = TONE_RES_ROOT_PATH"tone/mic_off.*",       //麦克风关
