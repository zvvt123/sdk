#ifndef CONFIG_BOARD_AC696X_LCD_CFG_H
#define CONFIG_BOARD_AC696X_LCD_CFG_H

#ifdef CONFIG_BOARD_AC696X_LCD
...
#if ((CONFIG_UI_STYLE == STYLE_JL_SOUNDBOX)&& (TCFG_DEC_AMR_ENABLE || TCFG_DEC_ALAC_ENABLE || TCFG_DEC_M4A_ENABLE || TCFG_DEC_WMA_ENABLE || TCFG_DEC_APE_ENABLE || TCFG_DEC_FLAC_ENABLE || TCFG_DEC_DTS_ENABLE))
#error "LCD 不支持多种解码格式 !!!"
#endif
