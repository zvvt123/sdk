...
/*
*********************************************************************
*                  Audio ADC Dither Frequency
* Description: 设置ADC Dither频率的大小
* Arguments  : dither_frequency  ADC Dither 的频率大小
* Return	 : None.
* Note(s)    : None.
*********************************************************************
*/

#define ADC_DITHER_FRE_23kHz  0  //ADC DITHER 频率为23kHz
#define ADC_DITHER_FRE_11Hz  1  //ADC DITHER 频率为11Hz
void  audio_adc_set_dither_frequency(u8 dither_frequency);
