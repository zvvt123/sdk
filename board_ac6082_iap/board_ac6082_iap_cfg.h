#ifndef CONFIG_BOARD_AC6082_IAP_CFG_H
#define CONFIG_BOARD_AC6082_IAP_CFG_H

#ifdef CONFIG_BOARD_AC6082_IAP
...
#if 1
#define TCFG_UART0_TX_PORT  				IO_PORTC_03//IO_PORTB_05                            //串口发送脚配置
...
//*********************************************************************************//
/*软件IIC设置*/
#define TCFG_SW_I2C0_CLK_PORT               IO_PORTA_04                             //软件IIC  CLK脚选择
...
#define	TCFG_HW_SPI2_ENABLE		0//ENABLE_THIS_MOUDLE
...
//VDDIO动态设置档位
#define TCFG_VDDIO_SET_DYNAMIC_EN           ENABLE
...
#define TCFG_EFFECT_TOOL_ENABLE				1//DISABLE		  	//是否支持在线音效调试,使能该项还需使能EQ总使能TCFG_EQ_ENABL,
...
#define TCFG_LINEIN_DETECT_ENABLE			DISABLE             //是否使用linein检测
#if (RECORDER_MIX_EN)
...
#define TCFG_DEC_MP3_ENABLE					0//ENABLE
