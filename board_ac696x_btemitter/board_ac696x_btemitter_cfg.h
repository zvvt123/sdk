#ifndef CONFIG_BOARD_AC696X_BTEMITTER_CFG_H
#define CONFIG_BOARD_AC696X_BTEMITTER_CFG_H

#ifdef CONFIG_BOARD_AC696X_BTEMITTER
...
// #define TCFG_VIRFAT_FLASH_ENABLE  1
...
#define TCFG_BLUETOOTH_BACK_MODE			1	//不支持后台模式
...
#if RECORDER_MIX_EN
#undef AUDIO_EFFECTS_DRC_AT_RAM
#define AUDIO_EFFECTS_DRC_AT_RAM 1  //开混合录音DRC放ram
#endif
...
#if (TCFG_USER_EMITTER_ENABLE  && (TCFG_DEC_APE_ENABLE || TCFG_DEC_FLAC_ENABLE || TCFG_DEC_M4A_ENABLE || TCFG_DEC_ALAC_ENABLE ||TCFG_DEC_AMR_ENABLE ||TCFG_DEC_DTS_ENABLE))
#error "发射只支持 mp3 wma wav 三种格式 !!!"
#endif//(TCFG_MIC_EFFECT_ENABLE && (TCFG_DEC_APE_ENABLE || TCFG_DEC_FLAC_ENABLE || TCFG_DEC_DTS_ENABLE))
...
#endif //CONFIG_BOARD_AC696X_BTEMITTER
#endif //CONFIG_BOARD_AC696X_BTEMITTER_CFG_H
