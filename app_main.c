...
void app_task_loop()
{
    while (1) {
        ...
        case APP_POWERON_TASK://开机任务
            log_info("APP_POWERON_TASK \n");
            app_poweron_task();
            break;
        case APP_POWEROFF_TASK://关机任务
            log_info("APP_POWEROFF_TASK \n");
            app_poweroff_task();
            break;
        case APP_BT_TASK://蓝牙任务
            log_info("APP_BT_TASK \n");
            app_bt_task();
            break;
        case APP_MUSIC_TASK://音乐任务
            log_info("APP_MUSIC_TASK \n");
            app_music_task();
            break;
        case APP_FM_TASK://FM任务
            log_info("APP_FM_TASK \n");
            app_fm_task();
            break;
        case APP_RECORD_TASK://录音任务
            log_info("APP_RECORD_TASK \n");
            app_record_task();
            break;
        case APP_LINEIN_TASK://线入任务
            log_info("APP_LINEIN_TASK \n");
            app_linein_task();
            break;
        case APP_RTC_TASK://RTC任务
            log_info("APP_RTC_TASK \n");
            app_rtc_task();
            break;
        case APP_PC_TASK://PC任务
            log_info("APP_PC_TASK \n");
            app_pc_task();
            break;
        case APP_SPDIF_TASK://SPDIF任务
            log_info("APP_SPDIF_TASK \n");
            app_spdif_task();
            break;
        case APP_IDLE_TASK://空闲任务
            log_info("APP_IDLE_TASK \n");
            app_idle_task();
            break;
        case APP_SLEEP_TASK://睡眠任务
            log_info("APP_SLEEP_TASK \n");
            app_sleep_task();
            break;
        case APP_SMARTBOX_ACTION_TASK://智能盒子任务
...
/////////////////////////FLASH 补丁///////////////////////////
    u32 flash_id;
    norflash_ioctl(NULL, IOCTL_GET_ID, (u32)&flash_id);
    if (flash_id == 0xcd7113) {
        JL_PORTD->HD0 &= ~BIT(4);
        JL_PORTD->HD &= ~BIT(4);
    }
////////////////////////////////////////////////////////////////
