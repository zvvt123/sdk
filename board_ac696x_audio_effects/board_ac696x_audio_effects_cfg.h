#ifndef CONFIG_BOARD_AC696X_AUDIO_EFFECTS_CFG_H
#define CONFIG_BOARD_AC696X_AUDIO_EFFECTS_CFG_H

#ifdef CONFIG_BOARD_AC696X_AUDIO_EFFECTS
...
//                                  UI 配置                                        //
//*********************************************************************************//
#define TCFG_UI_ENABLE 						1//ENABLE_THIS_MOUDLE 	//UI总开关
...
#define TCFG_EFFECT_TOOL_ENABLE				0//DISABLE		  	//是否支持在线音效调试,使能该项还需使能EQ总使能TCFG_EQ_ENABL,
...
#define CALLING_MIC_EFFECT_DISABLE     0 //通话过程中是否关闭混响 1关闭 0不关闭;//置1后会使用默认TCFG_AEC_ENABLE设置
...
#endif //CONFIG_BOARD_AC696X_AUDIO_EFFECTS
#endif //CONFIG_BOARD_AC696X_AUDIO_EFFECTS_CFG_H
