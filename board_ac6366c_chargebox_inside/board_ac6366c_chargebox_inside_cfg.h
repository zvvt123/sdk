#ifndef CONFIG_BOARD_AC6366C_CHARGEBOX_INSIDE_CFG_H
#define CONFIG_BOARD_AC6366C_CHARGEBOX_INSIDE_CFG_H
...
#define TCFG_CHARGE_MOUDLE_OUTSIDE                      DISABLE_THIS_MOUDLE //使用内置充电模块
#define TCFG_USB_KEY_UPDATE_ENABLE                      ENABLE_THIS_MOUDLE  //USB插入升级使能
#define TCFG_WIRELESS_ENABLE                            ENABLE_THIS_MOUDLE  //是否支持无线充
...
#define TCFG_HANDSHAKE_ENABLE                           ENABLE_THIS_MOUDLE  //充电握手协议
...
#define TCFG_CHARGEBOX_L_PORT                           IO_PORTB_00         //充电盒和左耳通信的IO口需要为高压IO
...
//PWR控制方式根据电路设计去选择
#define TCFG_PWR_CTRL_IO                                IO_PORTB_03//IO_PORTC_01         //耳机电源开关控制引脚
...
#define TCFG_PWR_CTRL_TYPE                              PWR_CTRL_TYPE_OUTPUT_1

#if TCFG_LDO_DET_ENABLE
#define TCFG_CHG_LDO_DET_IO                             IO_PORTB_06         //5V升压是否在成功检测IO
#define TCFG_CHG_LDO_DET_AD_CH                          AD_CH_PB6           //5V升压是否在成功检测AD通道
#endif
...
#define CHG_LED_MODE                                    1//timerLED模式有效 1--高亮 0--低亮, PWMLED模式请修改 PWM_LED_TWO_IO_CONNECT 这个宏定义
#define CHG_RED_LED_IO                                  IO_PORTA_05
#define CHG_GREEN_LED_IO                                IO_PORTA_04
#define CHG_BLUE_LED_IO                                 IO_PORTA_03
#endif

#if TCFG_CURRENT_LIMIT_ENABLE
#define TCFG_CURRENT_DET_IO                             IO_PORTB_07         //检测电流的IO,定义了TCFG_CURRENT_LIMIT_ENABLE才有效
#define TCFG_CURRENT_DET_AD_CH                          AD_CH_PB7           //耳机充电电流检测AD通道
#endif

#if TCFG_SHORT_PROTECT_ENABLE
#define TCFG_SHORT_PROTECT_IO                           IO_PORTB_06         //短路保护检测IO
...
#define TCFG_CHARGE_TEMP_IO                             IO_PORTB_04
#define TCFG_CHARGE_TEMP_AD_CH                          AD_CH_PB4
...
#define TCFG_HANDSHAKE_IO                               IO_PORTA_06         //握手IO
#endif

#if TCFG_WIRELESS_ENABLE
#define TCFG_WPC_COMM_IO                                IO_PORTC_03         //无线充电通信IO
#define TCFG_WL_AD_DET_IO                               IO_PORTC_04         //无线充电AD检测IO
#define TCFG_WL_AD_DET_CH                               AD_CH_PC4           //无线充电AD检测通道
#define TCFG_DCDC_CTRL_EN                               1                   //无线充电是否使能dcdc控制
#define TCFG_DCDC_EN_IO                                 IO_PORTC_05         //无线充电dcdc使能IO
#endif
