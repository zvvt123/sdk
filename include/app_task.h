...
//                               模式入口                                 //
//*********************************************************************************//
extern void app_bt_task();//蓝牙模式
extern void app_music_task();//音乐模式
extern void app_linein_task();//线控模式
extern void app_pc_task();//电脑模式
extern void app_record_task();//录音模式
extern void app_spdif_task();//spdif模式
extern void app_rtc_task();//rtc模式
extern void app_fm_task();//fm模式
extern void app_idle_task();//空闲模式
extern void app_poweroff_task();//关机模式
extern void app_poweron_task();//开机模式
extern void app_sleep_task();//睡眠模式
extern void app_smartbox_task(void);//智能盒子模式
