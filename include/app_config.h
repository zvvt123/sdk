...
#define VM_SPI_CODE_SEC_AT_DATA_RAM                                     0

#if (!VM_SPI_CODE_SEC_AT_DATA_RAM)
#define TCFG_VM_SPI_CODE_AT_RAM_DYANMIC                                 1
#else
#define TCFG_VM_SPI_CODE_AT_RAM_DYANMIC                                 0
#endif
...
#define CONFIG_FM_MOVABLE_CODE_SIZE     (0x3330 + 0x100)
//*********************************************************************************//
//                                 电源切换配置                                    //
//*********************************************************************************//
...
#define DEV_BEFORE_UPDATE_PROMPT		0
