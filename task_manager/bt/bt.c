...
void bt_function_select_init()
{
    set_idle_period_slot(200);  //默认值1600
...
static int bt_connction_status_event_handler(struct bt_event *bt)
{
    ...
    case BT_STATUS_A2DP_MEDIA_STOP:
        ...
        break;
    case BT_STATUS_SCO_STATUS_CHANGE:  // sco状态改变
...
int bt_key_event_handler(struct sys_event *event)
{
    ...
    case KEY_TWS_VOL_UP:
        bt_mute_flag = 0;
        tws_api_sync_call_by_uuid('T', SYNC_CMD_MAX_UP, TWS_SYNC_TIME_DO);
        break;
#endif
    case  KEY_VOL_DOWN:
        ...
        case KEY_BT_CONN_OR_DCONN:
       /*   if (get_call_status() == BT_CALL_INCOMING) {
          user_send_cmd_prepare(USER_CTRL_HFP_CALL_HANGUP, 0, NULL);  //先断连
          break;
        }*/
